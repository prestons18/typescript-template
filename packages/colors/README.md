...
```typescript
import { hexToRgb, rgbToHex, lighten, darken } from '@impress/colors';
...
Attempting to import from `@impress/strings` or `@impress/async` will result in a linting error due to module boundary constraints.
